...
public class Main_Pos {
    ...
    public static void main(String[] args) {
        ...
        fixBug(buggyProjectsPath, defects4jPath, projectName, args[7], args[8], args[9]);
    }

    public static void fixBug(String buggyProjectsPath, String defects4jPath, String buggyProjectName, String pm, String pt, String pf) {
        ...
        switch (granularity) {
            case Line:
                fixer = new Line_kParFixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            case Method:
                fixer = new Method_kParFixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            case File:
                fixer = new File_kParFixer(buggyProjectsPath, projectName, bugId, defects4jPath, pm, pt, pf);
                break;
            default:
                break;
        }
